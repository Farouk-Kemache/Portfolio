...
const descriptions = [
    ...
    "Photosnap Page Stories :Intégration responsive d’une galerie de récits visuels. Grille CSS fluide, effet de hover soigné et mise en page dynamique basée sur une maquette.",
    "Photosnap Page Pricing : J'ai codé cette page de tarification pour Photosnap en HTML, CSS. Elle présente trois plans (Basic, Pro, Business) avec un design épuré et une palette minimaliste (noir, blanc, rouge). L'objectif : offrir une expérience fluide et engageante pour les photographes et créateurs de contenu.",
